...
/**
 * Servlet implementation class ResolveSubTicket
 */
@WebServlet("/ResolveSubTicket")
public class ResolveSubTicket extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ResolveSubTicket() {
        super();
